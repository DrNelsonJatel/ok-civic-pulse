...
**CC BY 4.0** — see [LICENSE](LICENSE). It covers the code and the codebook.

[NOTICE.md](NOTICE.md) records what it cannot cover: the source material the
pipeline reads. None of that material is in this repository.
